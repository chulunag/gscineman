<div style="margin-left:12px;">
    ...
    <div>
        <div><span style="background-color:#000;color:#fff;padding:0 10px 0 10px"><strong>ROOM 02</strong></span><button class="btn-NP" val="2">P</button><button class="btn-NP" val="2">N</button></div>
    ...
    <div>
        <div><span style="background-color:#000;color:#fff;padding:0 10px 0 10px"><strong>ROOM 03</strong></span><button class="btn-NP" val="3">P</button><button class="btn-NP" val="3">N</button></div>
