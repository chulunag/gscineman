<div style="margin-left:12px;">
    ...
    <div role="room" value="1" style="height:100px;line-height:100px;background-color:#eee;">
        ...
        <!--        <button b="add-movie" style="width:30px;cursor:pointer">+</button>-->
    </div>

    <div style="clear:both;margin-top:12px"></div>

    <div role="room" value="2" style="height:100px;line-height:100px;background-color:#eee;">
        <div style="width:120px;color:#000;margin-right:12px;background-color:#d0e5f5"><span>ROOM<strong> 02 </strong></span><span role="time-start" contenteditable style="float:right">00:00</span></div>
        <!--        <button b="add-movie" style="width:30px;cursor:pointer">+</button>-->
    </div>
